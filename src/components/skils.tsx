    ...
    return (
      <section id="skills">
        <div className="text-center pt-20">
            <p className="text-4xl pb-10 text-center font-semibold whitespace-nowrap underline decoration-[#A04747]">スキル</p>
            ...
            {mainSkillData && mainSkillData.map((skill) => (
              <div className="flex justify-center items-left">
                <div className="md:w-full lg:mx-72">
                  {skill.skill.map((s) => (
                    <span className="inline-block rounded-full px-3 py-1 mr-2 mb-2 font-medium border bg-white border-gray-300">
                      <p>{s}</p>
                    </span>
                  ))
                  }
